...
from genres.horror import start_horror, first_choice_horror, second_choice_horror
...
class Adventure:
    ...
    async def start(self, language: str) -> str:
        ...
        if self.genre == "alternative history":
            ...
            self.characterName, self.characterDescription, self.emoji = await start_horror(language)
        else:
    ...
    async def first_choice(self, user_input: str, language: str) -> int:
        ...
        if self.genre == "alternative history":
            ...
            points = await first_choice_horror(user_input, language)
        else:
    ...
    async def second_choice(self, user_input: str, language: str) -> int:
        ...
        if self.genre == "alternative history":
            ...
            points = await second_choice_horror(user_input, language)
        else:

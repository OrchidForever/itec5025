...
from texts.greeting import ALT_GREETINGS
...
class UserInput:
    ...
    async def process_input(self, user_input: str) -> bool:
        ...
        if(self.step == 0):
            ...
            _ = await self.adventure.end_story(self.language, self.points)
            self.adventure = None
            self.emoji = "🎤"
            self.step = 0
            _ = await translate_text_print(ALT_GREETINGS, self.language)
        return True
